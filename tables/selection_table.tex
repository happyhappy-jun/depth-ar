...
Copy Update is worse than plain skipping everywhere. Best value per column in \textbf{bold}.
Fitted on 16 WikiText-103 sequences and evaluated on 16 disjoint held-out sequences, in FP32
on an NVIDIA TITAN X (Pascal) GPU.}
\label{tab:selection}
\begin{tabular}{llcc}
\toprule
