...
loss to \phm{5.99} against a dense \phm{2.33} and collapsed accuracy, \mname answers
\phm{132} more questions correctly out of \phm{900} than plain skipping, and \phm{90} more
at the larger budget: the only \phm{2} of \phm{37} comparisons we run that survive
Bonferroni correction. When a model must be compressed hard, predicting the missing update
rather than deleting it is worth a large and measurable number of answers.
