...
\phm{900} at $z=\phm{6.45}$ and $\phm{4.37}$, the only two of \phm{16} comparisons to
survive Bonferroni correction --- arise where layers are chosen to maximise recovery, and
...
five answers become ``$18.5\%$ of the accuracy gap recovered'', a figure that would sit
comfortably in an abstract and means nothing.
