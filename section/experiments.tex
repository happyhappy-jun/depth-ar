...
\paragraph{At a matched budget, likelihood recovery grows with scale.} \Cref{tab:main} carries the 7B comparison; at light budgets on
0.5B and 1.5B every accuracy delta is non-significant, consistent with the necessity rule, and
the full rows are in \Cref{tab:light}. At the light, damage-based operating point \mname
recovers
